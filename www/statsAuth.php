...
<thead>
<tr style="background-color:#B6DAFF;"><th align="left">Rank</th><th align="left" scope="col">User Name</th><th align="left" scope="col">MH/s</th><th align="left">&#3647;/Day<font size="1"> (est)</font></th></tr>
</thead>
<tbody>
<?php
...
echo "<tr><td class=\"leftheader\">Pool Hash Rate</td><td>". number_format($show_hashrate, 3) . " Ghash/s</td></tr>";
...
echo "<tr><td class=\"leftheader\">Next Network Block</td><td><a href=\"http://blockexplorer.com/b/" . $current_block_no . "\" target='_new'>";
echo number_format($current_block_no + 1) . "</a>";

echo " &nbsp;&nbsp;<font size='1'> (Current: <a href=\"http://blockexplorer.com/b/" . $current_block_no . "\" target='_new'>" .(number_format($current_block_no)). ")</font></a></td></tr>";

$show_difficulty = round($difficulty, 8);

echo "<tr><td class=\"leftheader\">Current Difficulty</th><td><a href=\"http://dot-bit.org/tools/nextDifficulty.php\" target='_new'><font size='2'>" . $show_difficulty . "</font></a></td></tr>";
